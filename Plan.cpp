...
#pragma link "cspin"
#pragma resource "*.dfm"
TPlan *Plan; int Count; AnsiString trip_plan =  "error.jpg";
//---------------------------------------------------------------------------
__fastcall TPlan::TPlan(TComponent* Owner)
	: TForm(Owner){}
//---------------------------------------------------------------------------
void __fastcall TPlan::ComboBox1Change(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TPlan::FormCloseQuery(TObject *Sender, bool &CanClose) //form close
{
	if(CanClose == true){
		MainPlayer->Visible = true; CSpinEdit3->Enabled=False; CSpinEdit4->Enabled=False;BitBtn1->Enabled=False;
...
//---------------------------------------------------------------------------
void __fastcall TPlan::DBListBox1DrawItem(TWinControl *Control, int Index, TRect &Rect,  //listbox alignment center
...
//---------------------------------------------------------------------------
void __fastcall TPlan::BitBtn1Click(TObject *Sender)
{
	 //search number
...
//---------------------------------------------------------------------------
void __fastcall TPlan::GroupBox2Click(TObject *Sender)
{
	CSpinEdit3->Enabled=True; CSpinEdit4->Enabled=True; BitBtn1->Enabled=True;
	LabeledEdit1->Enabled=False;
}
//---------------------------------------------------------------------------
void __fastcall TPlan::GroupBox1Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TPlan::FormCreate(TObject *Sender)
{
