...
#pragma resource "*.dfm"
TForm4 *Form4; int Item, kol_transfer;
...
{
	if(CanClose == true){ Form1->Visible = true;Image1->Picture->LoadFromFile("player\\human-error.jpg"); DateTimePicker1->Enabled=False;
...
void __fastcall TForm4::SpeedButton1Click(TObject *Sender)
{
	//add transfer
    Form7->Show();
	 Form7->DBLookupComboBox2->Visible=True; Form7->DateTimePicker2->Visible=True; Form7->DateTimePicker3->Visible=True; Form7->Edit1->Visible=True; Form7->Edit3->Visible=True;
	 Form7->BitBtn4->Enabled=True;  Form7->BitBtn4->Visible=True;  Form7->Label6->Visible=True;
	 ...
	 Form7->CheckBox1->Visible=False; Form7->BitBtn2->Visible=False; Form7->BitBtn3->Visible=False;Form7->BitBtn1->Visible=False;  Form7->Label5->Visible=False;
	 Form7->Label1->Caption="Початок контр.: ",Form7->Label2->Caption="Кінець контр.: ", Form7->Label3->Caption="Термін: ", Form7->Label4->Caption="Ціна/в млн.: ";
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TForm4::DBListBox1DrawItem(TWinControl *Control, int Index, TRect &Rect,
...
//---------------------------------------------------------------------------
void __fastcall TForm4::GroupBox2Click(TObject *Sender)
{
	//Enabled
